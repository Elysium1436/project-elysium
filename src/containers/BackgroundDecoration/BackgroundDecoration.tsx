...
function BackgroundDecoration({ positionClasses, linePosition }: BackgroundDecorationProps) {

  return (
    <div className="fixed w-full h-full top-0 left-0 pointer-events-none opacity-50">
